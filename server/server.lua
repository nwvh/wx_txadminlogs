...
AddEventHandler('txAdmin:events:playerBanned', function(eventData)
  ...
  if eventData.expiration ~= false then
      LogBan(eventData.author,GetPlayerName(eventData.target),eventData.reason,os.date('%d.%m.%Y %H:%M:%S', eventData.expiration),eventData.actionId,"Steam ID: "..steamid.."\nLicense: "..license.."\nDiscord: "..discord.."\nIP Address: "..ip)
    else
      LogBan(eventData.author,GetPlayerName(eventData.target),eventData.reason,"PERMANENT",eventData.actionId,"Steam ID: "..steamid.."\nLicense: "..license.."\nDiscord: "..discord.."\nIP Address: "..ip)
  end
